-- =============================================================================
-- Module 1: Setting Up
-- File: setup.sql (paste this into your Snowflake workspace)
-- Purpose: Automate role, warehouse, database, UDTF, and table creation
-- =============================================================================

-- 1. Switch to the ACCOUNTADMIN role
use role accountadmin;

-- 2. Create the Warehouse for compute/storage
create warehouse if not exists compute_wh
    with warehouse_size = 'large'
    auto_suspend = 300
    auto_resume = true;

-- 3. Create databases: RAW_DB for raw data, ANALYTICS_DB for transformed models
create database if not exists raw_db;
create database if not exists analytics_db;
use database raw_db;

-- 4. Create a Python UDTF to generate fake customer data
...
-- 5. Create a Python UDTF to generate a fake inventory of products
...
-- 6. Create a Python UDTF to generate fake customer order data
...
-- 7. Create the three tables using the UDTFs
...
-- 8. Preview the data in each table
select * from customers limit 10;
select * from products limit 10;
select * from orders limit 10;

-- 9. Setup completion confirmation
